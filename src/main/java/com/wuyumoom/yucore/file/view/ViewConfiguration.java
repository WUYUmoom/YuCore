...
public class ViewConfiguration {
    ...
    public ViewConfiguration(Configuration file) {
        ...
        for (String view : file.getConfigurationSection("Button").getKeys(false)) {
            button.put(view,new Button(file.getConfigurationSection("Button."+view)));
            //            button.put(
//                    view,
//                    new Button(view,file.getString("Button."+view+".name"),
//                            file.getString("Button."+view+".slot"),
//                            file.getStringList("Button."+view+".lore"),
//                            file.getString("Button."+view+".id",""),
//                            file.getBoolean("Button."+view+".enchantment"),
//                            file.getBoolean("Button."+view+".load",true),
//                            file.getStringList("Button."+view+".cmd")
//                    )
//            );
        }
    }
